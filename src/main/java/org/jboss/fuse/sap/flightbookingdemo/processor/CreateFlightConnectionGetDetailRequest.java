...
public class CreateFlightConnectionGetDetailRequest {
	...
	public void create(Exchange exchange) throws Exception {
		...
		SapSynchronousRfcDestinationEndpoint endpoint = exchange.getContext().getEndpoint("sap-srfc-destination:flbkdemoDest:BAPI_FLCONN_GETDETAIL", SapSynchronousRfcDestinationEndpoint.class);
