...
public class CreateFlightConnectionGetListRequest {
	...
	public void create(Exchange exchange) throws Exception {
		...
		SapSynchronousRfcDestinationEndpoint endpoint = exchange.getContext().getEndpoint("sap-srfc-destination:flbkdemoDest:BAPI_FLCONN_GETLIST", SapSynchronousRfcDestinationEndpoint.class);
